...
let autopilotDisconnectSound = new Audio(
  "https://raw.githubusercontent.com/damianryann/GeoFs-Immersion-SFX/main/737_autopilot_disconnect.mp3"
);
...
geofs.flyTo = function (a, b) {
  ...
  if (a) {
    ...
    geofs.api.getGuarantiedGroundAltitude([d, e, 0]).then(function (m) {
      ...
      k
        ? ((c.startAltitude =
            geofs.groundElevation + c.definition.startAltitude),
          (c.absoluteStartAltitude = !1))
        : c.absoluteStartAltitude || (c.startAltitude += geofs.groundElevation);
      c.llaLocation[2] = c.startAltitude;
      flight.elevationAtPreviousLocation = m;
      k
        ? ((f[1] = c.definition.startTilt || 0),
          (c.startOnGround = !0),
          (c.groundContact = !0),
        ...
        : ((c.startOnGround = !1),
          ...
          c.rigidBody.applyCentralImpulse(
            V3.scale(c.object3d.getWorldFrame()[1], m)
          ));
      geofs.undoPause(1);
...
function getScream() {
  if (
    ...
    if (
      geofs.animation.values.climbrate <= -6000 &&
      geofs.animation.values.kias > 300
    ) {
...
function resetLift() {
  geofs.animation.values.liftLeftWing =
    -geofs.aircraft.instance.parts.leftwing.lift / 50000 +
    ((geofs.animation.values.accZ - 9) / 50 +
      geofs.animation.values.shake / 1000) /
      (geofs.animation.values.kias / 150);
  geofs.animation.values.liftRightWing =
    -geofs.aircraft.instance.parts.rightwing.lift / 50000 +
    ((geofs.animation.values.accZ - 9) / 50 +
      geofs.animation.values.shake / 1000) /
      (geofs.animation.values.kias / 150);
}
...
function getAccel() {
  ...
  setTimeout(function () {
    accelerationL =
      (10 * (geofs.animation.values.liftLeftWing - lastWingPosL)) /
        geofs.animation.values.defL +
      1;
    accelerationR =
      (10 * (geofs.animation.values.liftRightWing - lastWingPosR)) /
        geofs.animation.values.defR +
      1;
  }, 10);
}
...
function getGroundSound() {
  if (geofs.animation.values.haglFeet < 20) {
    geofs.animation.values.groundSound =
      ((-geofs.animation.values.haglFeet + 20) *
        (geofs.animation.values.kias / 10)) /
      500;
  } else {
...
function getGearThud() {
  if (
    geofs.animation.values.gearPosition != 0 &&
    geofs.animation.values.gearPosition != 1
  ) {
...
function getSpoilerSound() {
  if (geofs.animation.values.airbrakesPosition != 0) {
    geofs.animation.values.spoilersSound =
      geofs.animation.values.airbrakesPosition *
      (geofs.animation.values.kias / 10);
  } else {
...
function getShake() {
  if (
    ...
    geofs.animation.values.shake =
      Math.random() * (geofs.animation.values.climbrate / 10);
    return;
  }
  if (geofs.animation.values.groundContact == 1) {
...
function getTouch() {
  if (
    ...
    geofs.animation.values.groundContact != 0
  ) {
...
function doShake() {
  getShake();
  geofs.camera.translate(
    0.0001 * geofs.animation.values.shake,
    0.0001 * geofs.animation.values.shake,
    0.0001 * geofs.animation.values.shake
  );
  setTimeout(function () {
...
function getRainVol() {
  ...
  if (
    weather.definition.precipitationAmount != 0 &&
    weather.definition.precipitationType === "rain"
  ) {
    if (geofs.animation.values.altitudeMeters <= weather.definition.ceiling) {
      geofs.animation.values.rainVol =
        (clamp(weather.definition.precipitationAmount, 0, 10) *
...
function getFinalSoundVolumes() {
  if (
    ...
    geofs.animation.values.engSoundMultR =
      (vDb / 2) * 7000 * clamp(geofs.animation.values.rpm, 0, 1);
...
function checkReverse() {
  if (geofs.animation.values.throttle < 0) {
    geofs.animation.values.reverseThrustVol =
      Math.abs(geofs.animation.values.throttle) * 10;
  } else {
...
function assignSounds() {
  geofs.aircraft.instance.definition.sounds[0].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/englowfront.ogg";
  geofs.aircraft.instance.definition.sounds[0].effects.volume.value =
    "engSoundMultF";
  geofs.aircraft.instance.definition.sounds[0].effects.pitch.value = "rpm";
  geofs.aircraft.instance.definition.sounds[1].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/engmidfront.ogg";
  geofs.aircraft.instance.definition.sounds[1].effects.volume.value =
    "engSoundMultF";
  geofs.aircraft.instance.definition.sounds[1].effects.pitch.value = "rpm";
  geofs.aircraft.instance.definition.sounds[2].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/enghighestfront.ogg";
  geofs.aircraft.instance.definition.sounds[2].effects.volume.value =
    "engSoundMultF";
  geofs.aircraft.instance.definition.sounds[2].effects.pitch.value = "rpm";
  geofs.aircraft.instance.definition.sounds[3].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/737rolling.mp3";

  geofs.aircraft.instance.definition.sounds[7] = {};
  geofs.aircraft.instance.definition.sounds[7].id = "rpmback";
  geofs.aircraft.instance.definition.sounds[7].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/enghighback.ogg";
  geofs.aircraft.instance.definition.sounds[7].effects = {
    volume: { value: "engSoundMultR", ramp: [6000, 10000, 20000, 50000] },
    pitch: {
      value: "rpm",
  ...
  geofs.aircraft.instance.definition.sounds[8].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/enghighback.ogg";
  geofs.aircraft.instance.definition.sounds[8].effects = {
    volume: { value: "engSoundMultR", ramp: [100, 500, 2000, 10000] },
    pitch: {
      value: "rpm",
      ramp: [1000, 20000, 20000, 20000],
      ratio: 1,
  ...
  geofs.aircraft.instance.definition.sounds[9].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/tlf.mp3";
  geofs.aircraft.instance.definition.sounds[9].effects = {
    start: { value: "isFlapsWarn" },
  };

  geofs.aircraft.instance.definition.sounds[10] = {};
  geofs.aircraft.instance.definition.sounds[10].id = "terrainwarn";
  geofs.aircraft.instance.definition.sounds[10].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/tlt.mp3";
  geofs.aircraft.instance.definition.sounds[10].effects = {
    start: { value: "isTerrainWarn" },
  };

  geofs.aircraft.instance.definition.sounds[11] = {};
  geofs.aircraft.instance.definition.sounds[11].id = "pullwarn";
  geofs.aircraft.instance.definition.sounds[11].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/pullup.mp3";
  geofs.aircraft.instance.definition.sounds[11].effects = {
    start: { value: "isPullupWarn" },
  };
  ...
  geofs.aircraft.instance.definition.sounds[12].effects = {
    start: { value: "isBankWarn" },
  };

  geofs.aircraft.instance.definition.sounds[13] = {};
  geofs.aircraft.instance.definition.sounds[13].id = "1000";
  geofs.aircraft.instance.definition.sounds[13].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/1000gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[13].effects = {
    start: { value: "gpws1000" },
  };

  geofs.aircraft.instance.definition.sounds[14] = {};
  geofs.aircraft.instance.definition.sounds[14].id = "500";
  geofs.aircraft.instance.definition.sounds[14].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/500correct.mp3";
  geofs.aircraft.instance.definition.sounds[14].effects = {
    start: { value: "gpws500" },
  };

  geofs.aircraft.instance.definition.sounds[15] = {};
  geofs.aircraft.instance.definition.sounds[15].id = "400";
  geofs.aircraft.instance.definition.sounds[15].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/400gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[15].effects = {
    start: { value: "gpws400" },
  };

  geofs.aircraft.instance.definition.sounds[16] = {};
  geofs.aircraft.instance.definition.sounds[16].id = "300";
  geofs.aircraft.instance.definition.sounds[16].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/300gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[16].effects = {
    start: { value: "gpws300" },
  };

  geofs.aircraft.instance.definition.sounds[17] = {};
  geofs.aircraft.instance.definition.sounds[17].id = "200";
  geofs.aircraft.instance.definition.sounds[17].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/200gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[17].effects = {
    start: { value: "gpws200" },
  };

  geofs.aircraft.instance.definition.sounds[18] = {};
  geofs.aircraft.instance.definition.sounds[18].id = "100";
  geofs.aircraft.instance.definition.sounds[18].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/100gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[18].effects = {
    start: { value: "gpws100" },
  };

  geofs.aircraft.instance.definition.sounds[19] = {};
  geofs.aircraft.instance.definition.sounds[19].id = "50";
  geofs.aircraft.instance.definition.sounds[19].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/50gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[19].effects = {
    start: { value: "gpws50" },
  };

  geofs.aircraft.instance.definition.sounds[20] = {};
  geofs.aircraft.instance.definition.sounds[20].id = "40";
  geofs.aircraft.instance.definition.sounds[20].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/40gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[20].effects = {
    start: { value: "gpws40" },
  };

  geofs.aircraft.instance.definition.sounds[21] = {};
  geofs.aircraft.instance.definition.sounds[21].id = "30";
  geofs.aircraft.instance.definition.sounds[21].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/30gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[21].effects = {
    start: { value: "gpws30" },
  };

  geofs.aircraft.instance.definition.sounds[22] = {};
  geofs.aircraft.instance.definition.sounds[22].id = "20";
  geofs.aircraft.instance.definition.sounds[22].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/20gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[22].effects = {
    start: { value: "gpws20" },
  };

  geofs.aircraft.instance.definition.sounds[23] = {};
  geofs.aircraft.instance.definition.sounds[23].id = "10";
  geofs.aircraft.instance.definition.sounds[23].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/10gpws_merged.mp3";
  geofs.aircraft.instance.definition.sounds[23].effects = {
    start: { value: "gpws10" },
  };

  geofs.aircraft.instance.definition.sounds[50] = {};
  geofs.aircraft.instance.definition.sounds[50].id = "retard";
  geofs.aircraft.instance.definition.sounds[50].file =
    "https://raw.githubusercontent.com/damianryann/GeoFs-Immersion-SFX/main/airbus_retard.mp3";
  geofs.aircraft.instance.definition.sounds[50].effects = {
    start: { value: "gpwsRetard" },
  };

  geofs.aircraft.instance.definition.sounds[24] = {};
  geofs.aircraft.instance.definition.sounds[24].id = "TCAS";
  geofs.aircraft.instance.definition.sounds[24].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/traffic.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[25].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/climb.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[26].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/descend.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[27].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/clear.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[28].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/lowcab.ogg";
  geofs.aircraft.instance.definition.sounds[28].effects = {
    volume: { value: "volumeCabin", ramp: [800, 950, 2500, 3500] },
    pitch: {
      value: "rpm",
  ...
  geofs.aircraft.instance.definition.sounds[29].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/midcab.ogg";
  geofs.aircraft.instance.definition.sounds[29].effects = {
    volume: { value: "volumeCabin", ramp: [1000, 2500, 10000, 10000] },
    pitch: {
      value: "rpm",
      ramp: [0, 20000, 20000, 20000],
      ratio: 1,
  ...
  geofs.aircraft.instance.definition.sounds[30].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/buzzsawcab.ogg";
  geofs.aircraft.instance.definition.sounds[30].effects = {
    volume: { value: "volumeCabin", ramp: [3000, 10000, 20000, 20000] },
  };

  geofs.aircraft.instance.definition.sounds[31] = {};
  geofs.aircraft.instance.definition.sounds[31].id = "reverse";
  geofs.aircraft.instance.definition.sounds[31].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/737reverse.mp3";
  geofs.aircraft.instance.definition.sounds[31].effects = {
    volume: { value: "reverseThrustVol", ramp: [0, 100, 1000, 2500] },
  };

  geofs.aircraft.instance.definition.sounds[32] = {};
  geofs.aircraft.instance.definition.sounds[32].id = "system";
  geofs.aircraft.instance.definition.sounds[32].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/737-800_cabin_system.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[33].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/737-800_cabin_ambience.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[34].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/hardtouch1.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[35].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/softtouch1.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[36].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/sounds_overspeed.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[37].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/wheelthud.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[38].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/sounds_rain.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[39].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/groundeffect1.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[40].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/flapslever.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[41].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/737flaps.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[42].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/sounds_trim.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[43].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/paxclap1.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[44].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/paxscream.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[45].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/nosetouch.ogg";
  ...
  geofs.aircraft.instance.definition.sounds[46].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/engfar.mp3";
  geofs.aircraft.instance.definition.sounds[46].effects = {
    volume: { value: "engSoundFar", ramp: [0, 2000, 10000, 10000] },
  };

  geofs.aircraft.instance.definition.sounds[47] = {};
  geofs.aircraft.instance.definition.sounds[47].id = "spool";
  geofs.aircraft.instance.definition.sounds[47].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/spoolcab.mp3";
  geofs.aircraft.instance.definition.sounds[47].effects = {
    volume: { value: "volumeCabin", ramp: [1500, 6000, 7000, 8000] },
    pitch: {
      value: "rpm",
      ramp: [3500, 10000, 20000, 20000],
      ratio: 1,
      offset: 1,
    },
  };
  ...
  geofs.aircraft.instance.definition.sounds[48].file =
    "https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/bump.mp3";
  ...
  geofs.aircraft.instance.definition.sounds[0].effects.volume.ramp = [
    100, 500, 2000, 10000,
  ];
  ...
  geofs.aircraft.instance.definition.sounds[3].effects.volume.ramp = [
    0, 50, 1000, 1000,
  ];
...
geofs.animation.values.gpwsRetard = 0;
...
function doRadioAltCall() {
  if (isApprConfig) {
    if (
      geofs.animation.values.haglFeet <= 1000 + restingPoint &&
    ...
    if (
      geofs.animation.values.haglFeet <= 500 + restingPoint &&
    ...
    if (
      geofs.animation.values.haglFeet > 5 + restingPoint &&
      geofs.animation.values.haglFeet <= 0 + restingPoint
    ) {
      geofs.animation.values.gpwsRetard = 1;
    } else {
      geofs.animation.values.gpwsRetard = 0;
    }
  } else {
...
function getTrafficProximity() {
  ...
  Object.values(multiplayer.visibleUsers).forEach(function (e) {
    if (e.distance <= 1000) {
      if (
        e.referencePoint.lla[2] >= geofs.animation.values.altitudeMeters &&
        e.referencePoint.lla[2] <= geofs.animation.values.altitudeMeters + 1000
      ) {
...
function getds() {
  dsl =
    geofs.animation.values.flexl +
    geofs.aircraft.instance.parts["leftwing"].lift +
    (geofs.animation.values.accZ - 9.8) * 30;
  dsr =
    geofs.animation.values.flexr +
    geofs.aircraft.instance.parts["rightwing"].lift +
    (geofs.animation.values.accZ - 9.8) * 30;
}
...
geofs.aircraft.instance.setup.parts[2].animations[0].function =
  "{return -geofs.animation.values.flexl}";
geofs.aircraft.instance.setup.parts[3].animations[0].function =
  "{return -geofs.animation.values.flexl}";
geofs.aircraft.instance.setup.parts[4].animations[0].function =
  "{return -geofs.animation.values.flexl}";

geofs.aircraft.instance.setup.parts[25].animations[0].function =
  "{return -geofs.animation.values.flexr}";
geofs.aircraft.instance.setup.parts[26].animations[0].function =
  "{return -geofs.animation.values.flexr}";
geofs.aircraft.instance.setup.parts[27].animations[0].function =
  "{return -geofs.animation.values.flexr}";
...
function yawDamper() {
  if (geofs.animation.values.haglFeet <= 200) {
    ...
    geofs.animation.values.rudderDamp =
      geofs.animation.values.yaw -
      av / ((1 / geofs.animation.values.pitch) * 40);
  }
}
